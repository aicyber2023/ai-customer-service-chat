            ...
            if (res.data.code == 200) {
                ...
                axios({
                    ...
                    setTimeout(() => {
                        ...
                        localStorage.setItem("employeeId", res.data.state.sessions[0].mask.id)
                    },1000)
    ...
    return (
        <div className={styles["auth-page"]}>
            ...
            <div className={styles["code"]}>
                <input type="text" placeholder={"请输入验证码"} value={imgCode} onChange={(e) => {
                    setImgCode(e.target.value)
                }}/>
                <img src={"data:image/jpeg;base64," + codeObj.data.img} onClick={() => {
                    getCode()
                }} width={80} height={40}/>
            </div>
