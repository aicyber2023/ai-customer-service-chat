...
const cs: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} zpráv s AoTu`,
    Actions: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Vynutit přidání simulovaného systémového promptu AoTu na začátek seznamu zpráv každého požadavku",
    },
    Update: {
