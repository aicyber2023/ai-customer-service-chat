...
const de: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} Nachrichten mit AoTu`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromAoTu: "Nachricht von AoTu",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Erzwingt das Hinzufügen eines simulierten systemweiten Prompts von AoTu am Anfang der Nachrichtenliste bei jeder Anfrage",
    },
    Update: {
