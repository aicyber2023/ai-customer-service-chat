...
const vi: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} tin nhắn với AoTu`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromAoTu: "Tin nhắn từ AoTu",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Bắt buộc thêm một prompt hệ thống giả lập AoTu ở đầu danh sách tin nhắn cho mỗi yêu cầu",
    },
    Update: {
