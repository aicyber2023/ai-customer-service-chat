...
const ru: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} сообщений с AoTu`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromAoTu: "Сообщение от AoTu",
  },
  Memory: {
    Title: "Память",
    EmptyContent: "Пусто.",
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Принудительно добавить симулированную системную подсказку AoTu в начало списка сообщений для каждого запроса",
    },
    Update: {
