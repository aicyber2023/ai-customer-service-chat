...
const es: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} mensajes con AoTu`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromAoTu: "Mensaje de AoTu",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Agregar forzosamente un prompt de sistema simulado de AoTu al comienzo de la lista de mensajes en cada solicitud",
    },
    Update: {
