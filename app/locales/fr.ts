...
const fr: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `${count} messages échangés avec AoTu`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromAoTu: "Message de AoTu",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Ajoute de force une invite système simulée de AoTu au début de la liste des messages pour chaque demande",
    },
    InputTemplate: {
      Title: "Template",
