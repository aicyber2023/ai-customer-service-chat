...
const tr: PartialLocaleType = {
  ...
  Chat: {
    SubTitle: (count: number) => `AoTu tarafından ${count} mesaj`,
    Actions: {
  ...
  Export: {
    ...
    MessageFromAoTu: "AoTu'nin Mesajı",
  },
  Memory: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Her istek için ileti listesinin başına simüle edilmiş bir AoTu sistem ipucu ekleyin",
    },
    Update: {
